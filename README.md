...
`irods_cfg_environment_file`                                          | var/lib/irods/.irods/irods_environment.json                 |                                                  | the location where the iRODS environment file should be placed relative to `irods_cfg_root_dir`
