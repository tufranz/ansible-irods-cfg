...
`irods_cfg_client_default_resource`                                   | `irods_cfg_default_resource_name`                                                    |                                                  | the name of the resource used for client or clerver operations if one is not specified
